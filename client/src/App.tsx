                ...
                <Routes>
                    <Route element={<RootLayout />}>
                        <Route element={<ProtectedRoute />}>
                            ...
                            <Route path='/classes/:classId/assignments/:assignmentId' element={<AssignmentDetailsPage />} />
                        </Route>
                        <Route element={<ProtectedRoute role='teacher' />}>
                            <Route path='/classes/create' element={<CreateClassPage />} />
                            <Route path='/classes/:classId/assignments/create' element={<CreateAssignmentPage />} />
                        </Route>
