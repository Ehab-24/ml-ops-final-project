...
export async function createClass(payload: ClassPayload): APIResponse<CreateClassResponse> {
    return apiCall<CreateClassResponse>(() => axiosInstance.post("classes/", payload))
}
...
export async function joinClass(payload: JoinClassPayload): APIResponse<JoinClassResponse> {
    return apiCall<JoinClassResponse>(() => axiosInstance.post("classes/join/", payload))
}
